...
export default function Map() {
    ...
    return (
        <div className='relative w-full'>
            ...
            <iframe onMouseLeave={() => { (overlay.current as unknown as HTMLDivElement).style.zIndex = 'auto'; }} src="https://www.google.com/maps/d/embed?mid=1MGoj-ojH26UAkE3XJi637a41FHjxSfc&ehbc=2E312F&noprof=1" className='w-full aspect-video object-cover border-2' />
        </div>
    );
}
