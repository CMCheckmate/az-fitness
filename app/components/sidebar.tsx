...
export default function SideBar({ session, signOutButton } : { session : Session | null, signOutButton : React.ReactNode }) {
    ...
    return (
        <div>
            ...
            <div ref={sidebar} onAnimationEnd={() => { const button = barButton.current as unknown as HTMLElement; button.style.pointerEvents = 'auto'; }} className='absolute top-0 right-0 translate-x-full z-10 w-min h-3/4 p-12 pt-24 bg-red-600 shadow-xl'>
