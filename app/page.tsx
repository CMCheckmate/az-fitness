      ...
      <div className='p-10 text-center'>
        ...
        <div className='flex flex-wrap justify-center'>
          <div className='max-w-full flex-1 m-5 flex flex-col items-center'>
            <Image src={placeholder} alt='Placeholder 1' className='w-1/2 min-w-44 p-5 rounded-full' />
          ...
          <div className='max-w-full flex-1 m-5 flex flex-col items-center'>
            <Image src={placeholder} alt='Placeholder 2' className='w-1/2 min-w-44 p-5 rounded-full' />
          ...
          <div className='max-w-full flex-1 m-5 flex flex-col items-center'>
            <Image src={placeholder} alt='Placeholder 3' className='w-1/2 min-w-44 p-5 rounded-full' />
