        ...
        <div>
            ...
            <div className='p-10 py-44 flex flex-col justify-center items-center bg-red-600'>
                ...
                <div className='p-10 grid grid-cols-4'>
                    ...
                    <a target='_blank' href={'https://onlyfans.com/azfitness'} className='mx-10 flex justify-center items-center text-white hover:text-red-200'>
                        <Image src={onlyFans} alt='Only Fans' className='w-min object-cover' />
                        <h3 className='text-xl font-bold'>Only Fans</h3>
                    </a>
                    <a target='_blank' href={'https://www.facebook.com/people/AZ-Fitness/61556892410672/'} className='mx-10 flex justify-center items-center text-white hover:text-red-200'>
                        <Image src={facebook} alt='Facebook' className='w-min object-cover' />
                        <h3 className='text-xl font-bold'>Facebook</h3>
                    </a>
                    <a target='_blank' href={'https://twitter.com/timelord2003'} className='mx-10 flex justify-center items-center text-white hover:text-red-200'>
